...
internal struct NFS3FileSystemInvoker<FS: NFS3FileSystemNoAuth, Sink: NFS3FileSystemResponder> {
    ...
    func handleNFSCall(_ callMessage: RPCNFS3Call, logger: Logger) {
        ...
        case .mount(let call):
            ...
            self.fs.mount(call, logger: logger, promise: promise)
        ...
        case .unmount(let call):
            ...
            self.fs.unmount(call, logger: logger, promise: promise)
        ...
        case .getattr(let call):
            ...
            self.fs.getattr(call, logger: logger, promise: promise)
        ...
        case .fsinfo(let call):
            ...
            self.fs.fsinfo(call, logger: logger, promise: promise)
        ...
        case .pathconf(let call):
            ...
            self.fs.pathconf(call, logger: logger, promise: promise)
        ...
        case .fsstat(let call):
            ...
            self.fs.fsstat(call, logger: logger, promise: promise)
        ...
        case .access(let call):
            ...
            self.fs.access(call, logger: logger, promise: promise)
        ...
        case .lookup(let call):
            ...
            self.fs.lookup(call, logger: logger, promise: promise)
        ...
        case .readdirplus(let call):
            ...
            self.fs.readdirplus(call, logger: logger, promise: promise)
        ...
        case .read(let call):
            ...
            self.fs.read(call, logger: logger, promise: promise)
        ...
        case .readdir(let call):
            ...
            self.fs.readdir(call, logger: logger, promise: promise)
        ...
        case .readlink(let call):
            ...
            self.fs.readlink(call, logger: logger, promise: promise)
        ...
        case .setattr(let call):
            ...
            self.fs.setattr(call, logger: logger, promise: promise)
